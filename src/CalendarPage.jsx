...
function buildEvents(activities, trainingSessions, projects) {
  ...
  activities.forEach(a => {
    ...
    events.push({
      ...
      type: "activity",
      title: `${ACT_ICONS[a.activity_type]||"📋"} ${a.company_name||a.company_id||"Aktivitas"}`,
      subtitle: `${Array.isArray(a.team_member_names)?a.team_member_names.join(", "):(a.team_member_name||"")} · ${a.start_time||""}${a.end_time?"-"+a.end_time:""}`,
      detail: a,
